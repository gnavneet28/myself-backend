...
router.post("/answer/:id", [auth, validateObjectId], async (req, res) => {
  ...
  const dataToProcess = `Imagine that there is a fictional character who is described as: ${character}. Now you know this fictional character very well, who has all the knowledge in the world and can answer any questions asked. Now if a person named ${req.user.name} and described as: ${characterOfCurrentUser} asks anything to you, you have to reply as if you are this character. Now give a valid response to this question: ${question}?`;
  try {
